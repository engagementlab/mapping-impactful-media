...
function GuideIndexPage() {
  ...
  return (
    <Layout>
      <div className="container mx-auto flex flex-col mb-14 items-center">
      ...
      <div className="container mx-auto flex flex-col lg:flex-row">
        <div className="px-5 md:px-0 flex justify-center flex-shrink-0 lg:w-2/5">
          <Image
            imgId="guide-landing"
            width={606}
        ...
        <div>
          <div className="text-center mb-14 font-work-sans text-2xl md:text-4xl lg:ml-16">
            <ReactMarkdown>
              {content.elApi.allGuideText[0].welcome}
            </ReactMarkdown>
