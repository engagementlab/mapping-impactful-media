      ...
      <div className="container mx-auto mt-14 mb-14 xl:mt-16 flex flex-col items-center">
        ...
        <div className="flex flex-col xl:flex-row justify-between mt-28 mb-24">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-11/12 rounded-55 bg-peach bg-opacity-25 mt-4 p-6 lg:p-12">
        ...
        <ReactMarkdown className="container w-11/12 lg:w-full p-4 mb-24 leading-7 tracking-wider font-work-sans text-2xl">
          {content.communities}
        </ReactMarkdown>

        <ReactMarkdown className="container w-11/12 lg:w-full p-4 mb-4 font-work-sans text-2xl">
          {content.media}
        </ReactMarkdown>
        ...
        <div className="flex flex-col xl:flex-row justify-between my-24">
          ...
          <div className="relative rounded-55 bg-peach bg-opacity-25 p-5 mx-4 lg:p-16 xl:ml-16 mt-9 lg:mt-0">
            <svg
              viewBox="0 0 53 74"
              width="53"
              height="74"
