...
function AboutPage() {
  ...
  return (
      ...
      <div id="about">
        <div
          className="container mx-auto flex justify-center mt-14 mb-14 xl:mt-48 xl:ml-90 text-2xl md:text-4xl text-sunny"
        >
        ...
        <div className="container mx-auto p-5 flex flex-col-reverse md:flex-row">
          <div
            className="w-full md:w-3/4 xl:w-5/12 xl:pt-32 xl:ml-36 leading-9 list-inside"
          >
          <ReactMarkdown>{aboutContent.elApi.allMimAboutPages[0].intro}</ReactMarkdown>
          </div>
        ...
        <div className="flex justify-center">
          <div className="lg:w-3/4 xl:w-1/3 px-6 lg:px-24 py-16 bg-pink">
            <ReactMarkdown>{aboutContent.elApi.allMimAboutPages[0].assumptions}</ReactMarkdown>
          </div>
        </div>
        ...
        <div className="relative xl:w-3/4 xl:left-64">
          ...
          <div
            className="relative z-10 font-geotica text-9xl text-right md:text-left md:ml-64 xl:ml-80 -mt-20"
          >
            1
          </div>
        ...
        <div className="relative xl:w-3/4 xl:left-64">
          ...
          <div className="relative h-40 -mt-64 md:w-1/2 md:left-1/2 bg-coral">
            <h1
              className="font-geotica text-9xl text-right md:text-center md:w-9/12 pt-20"
            >
              2
            </h1>
          </div>
        ...
        <div className="relative xl:w-3/4 xl:left-64">
          ...
          <div className="relative h-40 -mt-64 md:w-1/3 bg-bee">
            <div
              className="relative z-10 font-geotica text-9xl text-right lg:text-left pt-20 pr-5 lg:pl-40"
            >
              3
            </div>
          </div>
          <div
            className="relative p-4 xl:p-0 mt-14 md:ml-64 xl:ml-80 md:w-1/2 lg:w-1/3"
          >
